...
<div id="content">
  <div id="content-header">
    <div id="breadcrumb"> <a href="/manager/main.php" title="Go to Home" class="tip-bottom"><i class="icon-home"></i>主页</a> <a href="/manager/main.php" class="current">系统信息</a> </div>
  </div>
        ...
        <div class="widget-box">
          ...
          <div class="widget-content nopadding">
			...
			<tr>
				...
				<td width="70%" >&nbsp;<a href="/manager/phpinfo.php"
        ...
        <div class="widget-box">
          ...
          <div class="widget-content nopadding">
			...
			<tr>
				...
				<td width="80%" >&nbsp;&nbsp;<a
					href="http://www.zhmvc.com/" target="_blank">http://www.zhmvc.com/</a></td>
			</tr>
                        <tr>
				<td width="20%"  height="23">&nbsp;&nbsp;备案号</td>
				<td width="80%" >&nbsp;&nbsp;<a href="http://www.miitbeian.gov.cn" target="_blank">陇ICP备14000080号-2</a></td>
			</tr>
