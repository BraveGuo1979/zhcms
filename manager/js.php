...
<script src="<?php echo DS . 'manager' . DS?>js1/select2.min.js?id=<?php echo $CssRand;?>"></script> 
...
<script src="<?php echo DS . 'manager' . DS?>js1/matrix.form_common.js?id=<?php echo $CssRand;?>"></script> 
<script src="<?php echo DS . 'manager' . DS?>js1/wysihtml5-0.3.0.js?id=<?php echo $CssRand;?>"></script> 
<script src="<?php echo DS . 'manager' . DS?>js1/jquery.peity.min.js?id=<?php echo $CssRand;?>"></script> 
<script src="<?php echo DS . 'manager' . DS?>js1/bootstrap-wysihtml5.js?id=<?php echo $CssRand;?>"></script>
<script src="<?php echo DS . 'manager' . DS?>js1/jquery.validate.js?id=<?php echo $CssRand;?>"></script>
<script src="<?php echo DS . 'manager' . DS?>js1/DatePicker/WdatePicker.js?id=<?php echo $CssRand;?>"></script>
